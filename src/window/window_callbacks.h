...
typedef void (istd_stdcall* istd_pfn_mouse_button_callback)(istd_window, istd_mouse_button, istd_key_modifier, bool);
typedef istd_pfn_iconified_callback istd_pfn_mouse_entered_callback;

typedef void (istd_stdcall* istd_pfn_key_callback)(istd_window, istd_key, istd_key_modifier, bool);
typedef void (istd_stdcall* istd_pfn_char_callback)(istd_window, char32_t, istd_key_modifier);
...
static void istd_stdcall istd_defualt_mouse_button_callback(istd_window window, istd_mouse_button button, istd_key_modifier mods, bool down) {
	istd_unused_parameter(window);
...
static void istd_stdcall istd_defualt_key_callback(istd_window window, istd_key key, istd_key_modifier mods, bool down) {
	istd_unused_parameter(window);
...
static void istd_stdcall istd_defualt_char_callback(istd_window window, char32_t character, istd_key_modifier mods) {
	istd_unused_parameter(window);
